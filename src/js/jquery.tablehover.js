...
* Changelog: 
* v 0.1.5 - 2009-5-26
* Added support for the Ctrl Key.  if keycodeMain is 17 then the ctrl Key is currently depressed.
* v 0.1.4 - 2007-12-17
...
(function($) {
    ...
    *							Default value: '' (empty string)
    * @option {string} clickFunction		The name of the function to call when the ctrl key is pressed.
    *							Default value: '' (empty string)  
    *                           Returns a Function call with a TABLE Row ID.  <tr id="AnythingYouWant">
    *
    ...
    *
    * @example $('#table').tableHover({clickFunction:'testFunction', bodyCols: false, footCols: false, headCols: true, colClass: "someclass"});
    *
    * @type jQuery
    *
    * @name tableHover
