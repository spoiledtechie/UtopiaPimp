...
public partial class admin_admin_Users2 : System.Web.UI.Page
{
    ...
    protected void gvUsers_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        btnResetAccount.Attributes.Add("onclick", "javascript:ResetUsersAccount('" + gv.SelectedDataKey.Value.ToString()+ "', '" + Applications.Instance.ApplicationId + "');");
