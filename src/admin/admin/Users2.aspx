<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.master" AutoEventWireup="true" CodeFile="Users2.aspx.cs" Inherits="admin_admin_Users2" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  <asp:ScriptManagerProxy ID="smProx" runat="server"><Services><asp:ServiceReference Path="~/admin/admin/controls/admin.asmx" /></Services></asp:ScriptManagerProxy>
    <div>
        <ul class="ulList ulListSide">
            ...
            <li>Email:
                ...
                <asp:Button ID="btnEmailSearch" runat="server" Text=">" 
                    ...
                    <li>WildCard: %</li>
                    <li>
                       <asp:HyperLink ID="hlAllUsers" runat="server" NavigateUrl="~/admin/admin/Users.aspx">All Users</asp:HyperLink></li>
                    </ul>
    </div>
            ...
            <ContentTemplate>
                ...
                <div class="divUserColumns">
                  ...
                  <div class="divUserColumns">
                    ...
                    <input type="button" value="Reset Users Account" runat="server" id="btnResetAccount" />
                </div>
            </ContentTemplate>
            <Triggers>
                <asp:AsyncPostBackTrigger ControlID="gvUsers" EventName="SelectedIndexChanged" />
